...
{% img /i/chnm-basecamp1.png Screenshot of Basecamp %}
...
After doing all of this, either in one meeting or several, you should be set to move into the next phase of development: **Information Architecture**. I'll cover this next week!
  ...
  1. See Kelly Goto and Emily Cotler, _Web ReDesign 2.0: Workflow that Works_, Berkeley, CA: Peachpit Press, 2005, 40.
  2. Jesse James Garrett, _The Elements of User Experience: User-Centered Design for the Web_, New York: AIGA and New Riders, 2003, 23.
