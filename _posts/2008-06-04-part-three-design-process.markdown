...
{% img /i/gulag-screen.png Screenshot of Gulag: Many Days, Many Lives header %}
...
{% img /i/omeka-logo.jpg Logo for Omeka %}
...
{% img /i/wha-ps-screen.png Screenshot of photoshop mockup for Western History Association. %}
...
Here are a few things I keep in my toolkit and highly recommend:
  ...
  * Photoshop and Illustrator, with a host of brushes, patterns, and plugins. Make brushes and patterns yourself, and export them so other members of your team can use them too.
